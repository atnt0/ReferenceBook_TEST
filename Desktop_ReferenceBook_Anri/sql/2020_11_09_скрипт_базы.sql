...
--GO
--IF OBJECT_ID('dbo.AspNetRoleClaims','U') IS NOT NULL DROP TABLE AspNetRoleClaims;
--GO
--IF OBJECT_ID('dbo.AspNetUserLogins','U') IS NOT NULL DROP TABLE AspNetUserLogins;
--GO
--IF OBJECT_ID('dbo.AspNetRoles','U') IS NOT NULL DROP TABLE AspNetRoles;
--GO
--IF OBJECT_ID('dbo.AspNetUserClaims','U') IS NOT NULL DROP TABLE AspNetUserClaims;
--GO
--IF OBJECT_ID('dbo.AspNetUserRoles','U') IS NOT NULL DROP TABLE AspNetUserRoles;
--GO
--IF OBJECT_ID('dbo.AspNetUsers','U') IS NOT NULL DROP TABLE AspNetUsers;
--GO
--IF OBJECT_ID('dbo.AspNetUserTokens','U') IS NOT NULL DROP TABLE AspNetUserTokens;
--GO
