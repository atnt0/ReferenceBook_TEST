...
namespace RB.MVC.Controllers
{
    public class CompanyController : Controller
    {
        ...
        IGenericRepository<CompanyCategories, int> compcat;//категория-кампания
        IGenericRepository<CompanySubcategories, int> compSubcat;
        public CompanyController(IGenericRepository<Companies, Guid> companies, IGenericRepository<Photos, Guid> photos, IGenericRepository<Categories, int> categories,
            IGenericRepository<Subcategories, int> subcategories, IGenericRepository<CompanyCategories, int> compcat,
           IGenericRepository<CompanySubcategories, int> compSubcat)
        {
        ...
        //        return Json("OK");
        //    }
        //    public ActionResult GoodByFilter(ViewModelCompanyFind filter)
        //    {
